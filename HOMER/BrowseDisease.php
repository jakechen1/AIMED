    ...
    <div id="fw_container">
        <div id="fw_header">
            ...
            <ul class="submenu submenu_styling">
            	...
            	<li><a href="browsedisease.html">by Disease</a>&raquo;</li>
                <?php
                $term = $_GET['disease'];
        ...
        <div id="fw_content">
          ...
          <div class="tab-box">
          		<a href="browse.html" class="tabLink" id="cont-1">Browse by Organ</a>
                <a href="browsedisease.html" class="tabLink activeLink" id="cont-2">Browse by Disease</a>
          </div>          
...
oci_bind_by_name($s, ":diseaseid", $term);
oci_execute($s);
