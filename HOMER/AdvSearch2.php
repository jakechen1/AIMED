...
$flag[4] = !($term4=="min" and $term5=="max");
...
$flag[5] = !($term6=="min" and $term7=="max");
...
$flag[6] = !($term8=="min" and $term9=="max");
...
$flag[7] = !($term10=="min" and $term11=="max");
...
$sql_array[5] = "select dbest_tisged_hpa_unigene.* from dbest_tisged_hpa_unigene where zscore >=$term6 and zscore <=$term7";

//$sql_array[6] = "select dbest_tisged_hpa_unigene.* from dbest_tisged_hpa_unigene where l >=:aemin and l <=:aemax";
$sql_array[6] = "select dbest_tisged_hpa_unigene.* from dbest_tisged_hpa_unigene where l >=$term8 and l <=$term9";

//$sql_array[7] = "select dbest_tisged_hpa_unigene.* from dbest_tisged_hpa_unigene where re >=:remin and re <=:remax";
$sql_array[7] = "select dbest_tisged_hpa_unigene.* from dbest_tisged_hpa_unigene where re >=$term10 and re <=$term11";
